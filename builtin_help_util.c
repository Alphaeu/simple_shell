...
/**
 * help_all - to show all possible builtin shellby commands.
 */
void help_all(void)
{
...
/**
 * help_alias - to show information on the shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - to display information on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_help -to show information on the shellby builtin command 'help'.
 */
void help_help(void)
{
